...
@Component({
  selector: 'app-resultnavbar',
  templateUrl: './resultnavbar.component.html',
  styleUrls: ['./resultnavbar.component.css']
})
export class ResultnavbarComponent implements OnInit {
